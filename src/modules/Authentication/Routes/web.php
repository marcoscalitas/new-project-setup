...
Route::post('/auth/email/resend', function (Request $request, AuthenticationService $authenticationService) {
    $request->validate(['email' => ['required', 'email']]);
    $authenticationService->resendVerificationEmail($request->input('email'));
