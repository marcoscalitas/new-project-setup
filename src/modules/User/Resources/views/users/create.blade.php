...
@section('title', __('ui.add_user'))
@section('page-title', __('ui.add_user'))
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item" aria-current="page">{{ __('ui.add_user') }}</li>
@endsection
        ...
        <div class="col-span-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">{{ __('ui.basic_information') }}</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="grid grid-cols-12 gap-x-6">
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control"
                                        placeholder="{{ __('ui.enter_email') }}" value="{{ old('email') }}" required />
                                </div>
                            </div>
                            <div class="col-span-12 md:col-span-6">
                                <div class="mb-3">
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="password_confirmation" class="form-control"
                                        placeholder="{{ __('ui.confirm_password_placeholder') }}" required />
                                </div>
                            </div>
                            <div class="col-span-12">
                                <div class="mb-3">
                            ...
                            <x-admin::form-buttons :cancel-route="route('users.index')" :submit-label="__('ui.create_user')" />
                        </div>
                    </form>
